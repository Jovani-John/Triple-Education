...
function SignUp() {
  ...
  const handleGoogleSignIn = () => {
    setErrorGoolgeSignIn("Google Sign-Up غير متاح حالياً. يرجى استخدام النموذج أدناه.");
  };
      ...
      <div className="px-5 space-y-10 w-full md:w-[650px] mx-auto lg:bg-white rounded-xl p-5 lg:dark:bg-gray-900">
        ...
        <div className="space-y-5">
          ...
          <h2 className="text-center text-xl text-white">
            قم بأنشاء حساب في منصه تريبل
          </h2>
        </div>

        {/* sign up with google - معطل مؤقتاً */}
        <div
        ...
        <form className=" space-y-5" onSubmit={handleSubmit(onSubmit)}>
          ...
          {errorCodevisionSignUp && (
            <span className="block text-red-500">{errorCodevisionSignUp}</span>
          )}
