  ...
  return (
    <header className="min-h-[850px] grid lg:grid-cols-2 items-center pt-20 lg:pt-0 gap-5 relative">
      ...
      >
        ...
        >
          منصه تريبل ليست مجرد منصة تعليمية، بل هي رؤية مستقبلية لكل من يسعى إلى
          احتراف تطوير الويب، وتحقيق التميز التقني، والانطلاق نحو فرص وظيفية
          واعدة. 🚀
        </motion.p>
      ...
      >
        ...
        >
          <strong className="text-xl select-none">الدروس التعليمية 80</strong>
        </motion.div>
        ...
        >
          <strong className="text-xl select-none">الساعات التعليمية 202</strong>
        </motion.div>
        ...
        >
          <strong className="text-xl select-none">المتعلمين 2000</strong>
        </motion.div>
