  ...
  return (
    ...
    >
      <h1 className="text-4xl mb-10 font-bold rounded-lg dark:text-white transition-colors">
        ابدأ تعلم تطوير الويب مع منصه تريبل الآن!
      </h1>

      <div className="text-xl dark:text-gray-300 font-medium leading-10 transition-colors">
        <p>
          هل أنت مستعد للانطلاق في عالم تطوير الويب؟ مع منصه تريبل، لديك الفرصة
          لتعلم المهارات التي ستمكنك من بناء مواقع وتطبيقات تفاعلية بطريقة ممتعة
          وسهلة. في منصه تريبل، نؤمن أن الجميع يمكنه أن يصبح مطور ويب محترف، بغض
          النظر عن خلفيته أو خبرته السابقة.
        </p>

        <p>
          لا تفوّت فرصة التغيير، وابدأ رحلة تعلمك مع منصه تريبل اليوم! اضغط على
          زر "ابدأ الآن" لتبدأ في تعلم تطوير الويب خطوة بخطوة وتحقيق طموحاتك
          المهنية.
        </p>
      </div>
